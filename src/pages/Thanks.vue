    ...
    <b-container>
      <nav class="navbar navbar-expand-sm navbar-light bg-light">
        ...
        <ul class="nav navbar-nav">
          <li class="nav-item">
            <g-link class="nav-link btn btn-primary small" to="/"
              >View Map</g-link
            >
          </li>
        </ul>
      ...
      <b-row>
        <b-col class="col-md-6 offset-md-3 mt-5 pt-5 pb-4">
          ...
          <br />
          <p>
             We're humbly asking you to <b>share the link</b> on social media! <br/><br/>C'mon, give your plot on the map an extra push! Spread the love now and come back tomorrow to see your Buffalo Startup.
          </p>
